<section id="home" class="hero-area img-bg" data-background="/image/site/hero/hero-bg-1.svg" style="background-image: url(&quot;assets/img/hero/hero-bg-1.svg&quot;);">
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-6">
        <div class="hero-content-wrapper">
          <h1 class="wow fadeInUp" data-wow-delay=".2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">ThemeWadi</h1>
          ...
          <a href="javascript:void(0)" class="main-btn wow fadeInUp" data-wow-delay=".8s" style="visibility: visible; animation-delay: 0.8s; animation-name: fadeInUp;">Learn More</a>
        </div>
      </div>
      <div class="col-lg-6">
        <div class="hero-img wow fadeInUp" data-wow-delay="1s" style="visibility: visible; animation-delay: 1s; animation-name: fadeInUp;">
