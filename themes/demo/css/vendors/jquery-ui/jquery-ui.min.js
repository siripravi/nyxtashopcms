          ...
          flip: {
            ...
            top: function (t, e) {
              ...
              0 > u
                ...
                : c > 0 &&
                  ((i = t.top - e.collisionPosition.marginTop + p + f + m - l),
            ...
            this.selectees.each(function () {
              ...
              i &&
                ...
                "touch" === n.tolerance
                  ...
                  : "fit" === n.tolerance &&
                    (h =
                      u.left > o && r > u.right && u.top > a && l > u.bottom),
                h
                  ? (i.selected &&
    ...
    t.widget("ui.sortable", t.ui.mouse, {
      ...
      _refreshItems: function (e) {
        ...
        for (i = c.length - 1; i >= 0; i--)
          for (a = c[i][1], r = c[i][0], s = 0, h = r.length; h > s; s++)
            (l = t(r[s])),
      ...
      if ((0 > J && ((J += 12), te--), Z))
        for (
          e = this._daylightSavingAdjust(
            ...
            e = Q && Q > e ? Q : e;
          this._daylightSavingAdjust(new Date(te, J, 1)) > e;
      ...
      for (
        t.drawMonth = J,
          ...
          i = V
            ? this.formatDate(
                i,
                this._daylightSavingAdjust(new Date(te, J - $, 1)),
        ...
        for (C = "", this.maxRows = 4, k = 0; U[1] > k; k++) {
          if (
            ((D = this._daylightSavingAdjust(new Date(te, J, t.selectedDay))),
            (I = " ui-corner-all"),
            (P = ""),
            X)
          ) {
          ...
          for (
            P += T + "</tr></thead><tbody>",
              M = this._getDaysInMonth(te, J),
              te === t.selectedYear &&
                J === t.selectedMonth &&
                (t.selectedDay = Math.min(t.selectedDay, M)),
              z = (this._getFirstDayOfMonth(te, J) - u + 7) % 7,
              H = Math.ceil((z + M) / 7),
              O = X ? (this.maxRows > H ? this.maxRows : H) : H,
              this.maxRows = O,
              A = this._daylightSavingAdjust(new Date(te, J, 1 - z)),
              W = 0;
            O > W;
            W++
          ) {
            for (
              ...
              (N = g ? g.apply(t.input ? t.input[0] : null, [A]) : [!0, ""]),
                (F = A.getMonth() !== J),
                (L = (F && !v) || !N[0] || (Q && Q > A) || (Z && A > Z)),
                (E +=
                  "<td class='" +
