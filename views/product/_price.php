        ...
        <div class="row">
            <div class="col">
                <?php if ($available !== 0): ?>
                  ...
                  <button data-Xbs-target="#offcanvasCart" data-Xbs-toggle="offcanvas" class="btn btn-success btn-buy" rel="price<?= $model->id ?>">
					<?= $available > 0 ? Yii::t('app', 'Add  Cart') : Yii::t('app', 'Buy This') ?></button>
                 <?php endif; ?>
            </div>
            <div class="col">
