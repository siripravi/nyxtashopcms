    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            ...
            echo \yii\bootstrap5\Nav::widget([
                'options' => ['class' => 'menu'],
                'encodeLabels' => false,
                //'itemOptions' => ['class'=>'sidebar-item has-sub'],
                'items' => [
                    "<li class='sidebar-title'>Product Config<li>",
                    [
                        'label' => '<i class="bi bi-card-text"></i><span>Categories</span>',
                        'url' => ['/admin/products/category/index'],
                        'linkOptions' => ['class' => 'sidebar-item active'],
                      //  'htmlOptions' => ['class' => 'sidebar-item active']
                    ],
                    [
                        'label' => '<i class="bi bi-grid-fill"></i><span>Brands</span>',
                        'url' => ['/admin/products/brand/index'],
                        'linkOptions' => ['class' => 'sidebar-link'],
                        'htmlOptions' => ['class' => 'sidebar-item']
                    ],
                    [
                        'label' => '<i class="bi bi-grid-fill"></i><span>Features</span>',
                        'url' => ['/admin/products/feature/index'],
                        'linkOptions' => ['class' => 'sidebar-link'],
                        'htmlOptions' => ['class' => 'sidebar-item']
                    ],
                    [
                        'label' => '<i class="bi bi-card-text"></i><span>Values</span>',
                        'url' => ['/admin/products/value/index'],
                        'linkOptions' => ['class' => 'sidebar-link'],
                        'htmlOptions' => ['class' => 'sidebar-item']
                    ],
                    [
                        'label' => '<i class="bi bi-currency-dollar"></i><span>Currencies</span>',
                        'url' => ['/admin/products/currency/index'],
                        'linkOptions' => ['class' => 'sidebar-link'],
                        'htmlOptions' => ['class' => 'sidebar-item']
                    ],
                    [
                        'label' => '<i class="bi bi-card-text"></i><span>Units</span>',
                        'url' => ['/admin/products/unit/index'],
                        'linkOptions' => ['class' => 'sidebar-link'],
                        'htmlOptions' => ['class' => 'sidebar-item']
                    ],
                    [
                        'label' => '<i class="bi bi-toggle2-on"></i><span>Status Labels</span>',
                        'url' => ['/admin/products/product-status/index'],
                        'linkOptions' => ['class' => 'sidebar-link'],
                        'htmlOptions' => ['class' => 'sidebar-item']
                    ],
                     "<li class='sidebar-title'>Shop Elements<li>",  
                 
                    [
                        'label' => '<i class="bi bi-justify"></i><span>Products</span>',
                        'url' => ['/admin/products/default/index'],
                        'linkOptions' => ['class' => 'sidebar-link'],
                        'htmlOptions' => ['class' => 'sidebar-item']
                    ],
                    [
                        'label' => '<i class="bi bi-justify"></i><span>Groups</span>',
                    ...
                    [
                        ...
                        'url' => ['/admin/slider/'],
                        'linkOptions' => ['class' => 'sidebar-item'],
                        'htmlOptions' => ['class' => 'sidebar-link']
                    ],
                    [
                    ...
                    [
                        'label' => 'Invoice',
                        'items' => [
                            ['label' => '<i class="bi bi-grid-1x2-fill"></i>List Invoice', 'url' => ''],
                            '<div class="dropdown-divider"></div>',
                            '<div class="dropdown-header">Dropdown Header</div>',
                            ['label' => 'Level 1 - Dropdown B', 'url' => '#'],
                        ],
                        'linkOptions' => ['class' => 'sidebar-link'],
                        'htmlOptions' => ['class' => 'sidebar-item has-sub'],
                        'itemOptions' => ['class' => 'submenu'],
                    ],
